...
const ITEMS = [
  ...
  { id: 6, src: "/images/frota6.jpg", thumb: "/images/frota6.jpg", type: "image", tag: "frota", alt: "Caminhões basculantes da frota Nova Max em operação de terraplenagem." },
  { id: 7, src: "/images/frota7.jpg", thumb: "/images/frota7.jpg", type: "image", tag: "frota", alt: "Motoniveladora atuando no nivelamento de solo para pavimentação." },
  { id: 8, src: "/images/frota8.jpg", thumb: "/images/frota8.jpg", type: "image", tag: "frota", alt: "Escavadeira hidráulica em serviço de escavação e movimentação de terra." },
  ...
  { id: 24, src: "/images/equipe5.jpg", thumb: "/images/equipe5.jpg", type: "image", tag: "equipe", alt: "Equipe Nova Max em operação de campo." },
  { id: 25, src: "/images/equipe6.jpg", thumb: "/images/equipe6.jpg", type: "image", tag: "equipe", alt: "Profissionais qualificados atuando em obra de infraestrutura." },

  { id: 26, src: "/images/video-book.mp4", thumb: "/images/video-book.jpg", type: "video", tag: "video", alt: "Conheça a Nova Max em operação. Neste vídeo institucional, apresentamos nossa frota própria, a atuação da equipe em campo e a execução de obras de terraplenagem, drenagem, pavimentação e logística pesada. Um retrato real da nossa capacidade operacional, do compromisso com prazos e da seriedade com que conduzimos cada projeto de infraestrutura, do planejamento à entrega final." }
];
